...
<div>
<img src="https://github.com/user-attachments/assets/64e5ba9c-446c-4786-85b2-90e33276b036" />
</div>

<div>
<img src="https://github.com/user-attachments/assets/d3c0790b-9e2f-496c-b96b-2a08a57e79ed" />
</div>

实现原理：在`index.htmml`中添加一个看不见的空白音频在后台播放，引入`media.js`实现功能，播放控制仍由页面控制，再结合状态接口和mediaSession信息的写入。
